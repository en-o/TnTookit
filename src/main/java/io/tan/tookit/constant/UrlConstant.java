...
public class UrlConstant {
     ...
     * 根据版本下载 // 《MessageFormat.format(MAVEN_DOWNLOAD_URL,openRestyName,3.6.3,3.6.3)》
     */
    public static final String MAVEN3_DOWNLOAD_URL = "https://dlcdn.apache.org/maven/maven-3/{0}/binaries/apache-maven-{1}-bin.zip";
